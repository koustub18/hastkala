                  ...
                  <tr key={product.id} className="hover:bg-earth-50 transition-colors">
                    <td className="p-4">
                      {product.images && product.images.length > 0 ? (
                        <img src={product.images[0]} alt={product.title} className="w-10 h-10 object-cover rounded shadow-sm border border-earth-200" />
                      ) : (
                    ...
                    <td className="p-4 text-right">
                      <span className="text-sm text-earth-500">
                        {product.createdAt ? new Date(product.createdAt.toMillis()).toLocaleDateString() : '-'}
                      </span>
                    </td>
                  </tr>
                ))
